...
public class Event {
    ...
    public void setChefById(int chefId) {
        this.chef = User.loadUserById(chefId);
    }
    ...
    public static ArrayList<Event> loadAllEvents() {
        ...
        PersistenceManager.executeQuery(query, new ResultHandler() {
            ...
            public void handle(ResultSet rs) throws SQLException {
                ...
                e.chef = User.loadUserById(rs.getInt("chef_id"));
                events.add(e);
            }
        });
    ...
    private static Event loadEventByQuery(String query, Object param) {
        ...
        PersistenceManager.executeQuery(query, new ResultHandler() {
            ...
            public void handle(ResultSet rs) throws SQLException {
                ...
                try {
                    e.chef = User.loadUserById(rs.getInt("chef_id"));
                    e.org = User.loadUserById(rs.getInt("org_id"));
                } catch (Exception ex) {
                    e.chef = null;
                    e.org = null;
                }
        ...
        if (result != null) {
            try {
                ...
                result.note = Note.loadNoteByEvent(result);
            } catch (Exception ex) {
