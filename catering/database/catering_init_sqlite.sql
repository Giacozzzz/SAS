...
DROP TABLE IF EXISTS `HolidaysRequests`;
...
CREATE TABLE
    `HolidaysRequests`(
        ...
        `approval` INTEGER NOT NULL DEFAULT 0 CHECK(`approval` IN (0,1)),
        `approval_date` DATE,
         FOREIGN KEY (`user_id`) REFERENCES `Users` (`id`)
    );
...
('Marco.CatERing'),      -- ID 1
('Giulia.CatERing'),   -- ID 2
('Luca.CatERing'),       -- ID 3
('Sofia.CatERing'),      -- ID 4
('Antonio.CatERing'), -- ID 5
('Chiara.CatERing'),   -- ID 6
('Giovanni.CatERing'),   -- ID 7
('Francesca.CatERing'); -- ID 8
...
INSERT INTO UserRoles (user_id, role_id) VALUES
(8, 4); -- Francesca is both an organizer and the owner

-- Add collaborators
INSERT INTO Collaborators (user_id, name, contact, CF, address, availability, holiday_days, work_hours) VALUES
(1, 'Marco', 'marco@email.com', NULL, NULL, 0, NULL, NULL), -- Non è stato ingaggiato
(2, 'Giulia', 'giulia@email.com', 'GIL23S', 'Via di Giulia 23', 1, NULL, NULL), -- E' occasionale
(3, 'Luca', 'luca@email.com', NULL, NULL, 0, NULL, NULL), -- Non è stato ingaggiato
(4, 'Sofia', 'sofia@email.com', 'SOF03C', 'Via di Sofia 430', 1, 20, 200), -- E' permanente
(5, 'Antonio', 'antonio@email.com', 'ATN20H', 'Via di Antonio 205', 1, NULL, NULL), -- E' occasionale
(6, 'Chiara', 'chiara@email.com', 'CHR21O', 'Via di Chiara 126', 0, 5, 150), -- E' permanente
(7, 'Giovanni', 'giovanni@email.com', 'GVN32O', 'Via di Giovanni 327', 1, NULL, NULL), -- E' occasionale
(8, 'Francesca', 'francesca@email.com', 'FCR42P', 'Via di Francesca 284', 1, 15, 200); -- E' permanente e proprietario

-- Add holiday requests
-- Due ferie della stessa persona in conflitto tra loro (Sofia)
INSERT INTO HolidaysRequests (user_id, start_date, end_date, approval, approval_date) VALUES
(4, '2025-08-13', '2025-08-23', 0, NULL), -- accettata
(4, '2025-08-14', '2025-08-24', 0, NULL); -- rifiutata: conflitto ferie

-- Ferie non consentite a causa di Holiday Days = 0 (Chiara)
INSERT INTO HolidaysRequests (user_id, start_date, end_date, approval, approval_date) VALUES
(6, '2025-09-01', '2025-09-05', 0, NULL), -- consentito
(6, '2025-09-10', '2025-09-15', 0, NULL); -- non consentito: Holiday Days = 0

-- Due ferie “normali” da approvare/rifiutare manualmente (Francesca)
INSERT INTO HolidaysRequests (user_id, start_date, end_date, approval, approval_date) VALUES
(8, '2025-08-01', '2025-08-15', 0, '2025-07-15'),  -- rifiutata
(8, '2025-08-01', '2025-08-10', 0, NULL),  -- approvata
(8, '2025-09-01', '2025-09-05', 0, NULL),  -- rifiutata
(8, '2025-09-10', '2025-09-15', 0, NULL);  -- da rifiutare: conflitto turno

-- Ferie non consentite a causa del tipo di collaboratore (Giulia, occasional)
INSERT INTO HolidaysRequests (user_id, start_date, end_date, approval, approval_date) VALUES
(2, '2025-09-01', '2025-09-05', 0, NULL);

-- Shifts
INSERT INTO Shifts (date, start_time, end_time) VALUES
('2025-08-12', '10:00:00', '14:00:00'),  -- turno mattina, sovrapposto alle ferie di Sofia
('2025-08-15', '12:00:00', '16:00:00'),  -- turno pomeriggio
('2025-09-03', '09:00:00', '13:00:00'),  -- turno sovrapposto alle ferie di Giulia
('2025-09-12', '10:00:00', '14:00:00');  -- turno sovrapposto alle ferie di Antonio

-- ShiftBookings
INSERT INTO ShiftBookings (shift_id, user_id) VALUES
(1, 4),  -- Sofia, 12 agosto mattina (sovrapposto alle ferie, per test)
(2, 6),  -- Chiara, 15 agosto pomeriggio
(3, 5),  -- Antonio, 3 settembre mattina
(4, 8);  -- Francesca, 12 settembre mattina
...
-- Create a new event
INSERT INTO Events (name, date_start, date_end, chef_id, org_id) VALUES
('Gala Aziendale Annuale', date('2025-06-15'), date('2025-06-16'), 5, 6);  -- Assigned to Antonio and Chiara
...
INSERT INTO Notes (event_id, owner_id, note) VALUES
(1, 6, 'Il Gala Aziendale Annuale ha eventato bene.');